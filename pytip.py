from typing import List, Dict, Tuple, Optional, Union, Any, Callable, TypeGuard, TypedDict, Annotated
...
LOCAL_CSV = 'daily-python-tip.csv'
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <2:
        sys.exit('Call the script with one or more search terms')
    ...
    if not tips:
        print('Nothing found, you can submit a tip here:')
    else:
